...
function ponerVerbo(){
  ...
  // ===================================
  first.classList.add("btn","btn-outline-secondary","btn-md");
  second.classList.add("btn","btn-outline-secondary","btn-md");
  third.classList.add("btn","btn-outline-secondary","btn-md");
  fourth.classList.add("btn","btn-outline-secondary","btn-md");
